...
<figure><img src="/images/etc/arduino-error-stk5001.PNG" alt=""></figure>
...
<figure><img src="/images/etc/arduino-error-stk5002.PNG" alt=""></figure>

첫번째로 도구에 보드 메뉴에 현재 사용하는 보드와 같은 보드로 설정되어있는지 확인해주세요. 저는 이때 Mega2560이 아닌 Uno로 잡혀있어서 제 보드에 맞는 Mega2560으로 설정했어요.

<figure><img src="/images/etc/arduino-error-stk5003.png" alt=""></figure>
